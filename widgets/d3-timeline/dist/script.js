(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
      ...
      console.log(colorCycle(d3.schemeCategory10));
    ...
    function timeline (gParent) {
      ...
      // console.log("gParent");
      // console.log(gParent);
      // console.log(gParent._groups);
      var gParentSize = gParent._parents[0].getBoundingClientRect();

      var gParentItem = d3.select(gParent._parents[0]);
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            .append(function(d, i) {
                ...
                var result = document.createElementNS(d3.namespace("svg"), "display" in d? d.display:display);
                console.log("append namespace result");
                console.log(result);
                return result;
            })
            .attr("x", getXPos)
            ...
            .attr("r", itemHeight / 2)
            .attr("height", itemHeight)
            // TODO : re-write this section according to styles sepecification (should be called on a selection)
            ...
            //     dColorPropName = d[colorPropertyName];
            //     if ( dColorPropName ) {
            //       return {"fill": colorCycle( dColorPropName )};
            //     } else {
            //       return {"fill": colorCycle( datum[colorPropertyName] )};
            //     }
            //   }
            //   return {"fill": colorCycle(index)};
            // })
...
console.log('')
      ...
      // Frise qui nous interesse (timelineAxisTop)
